...
import net.cheney.webdav.resource.api.Elements;
import net.cheney.webdav.resource.api.Lock;
import net.cheney.webdav.resource.api.Property;
import net.cheney.webdav.resource.api.Resource;
import net.cheney.webdav.resource.api.ResourceProvidor;
import net.cheney.webdav.resource.api.Elements.ACTIVE_LOCK;
import net.cheney.webdav.resource.api.Elements.MULTISTATUS;
import net.cheney.webdav.resource.api.Elements.PROPSTAT;
import net.cheney.webdav.resource.api.Elements.RESPONSE;
...
public class WebDAVApplication implements Application {
	
	private static final Logger LOG = Logger.getLogger(WebDAVApplication.class);
	...
	public WebDAVApplication(ResourceProvidor providor) {
